...
public class EntityPresenter : MonoBehaviour
{
    ...
    {
        m_boardPresenter.Initialize(entityModel.Board, entityModel.Hand, entityModel.Mana);
        m_handPresenter.Initialize(entityModel.Hand, entityModel.Board, entityModel.Mana, !entityModel.IsPlayer, entityModel.IsPlayer, entityModel.IsPlayer);
